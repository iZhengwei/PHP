...
<title>添加信息</title>
<link rel="stylesheet" type="text/css" href="/tpoa/Public/Images/css1/css.css" />
<script type="text/javascript" src="/tpoa/Public/ckeditor/ckeditor.js"></script>
<style>
td, th {
	text-align: center;
}
...
<body>
<form method='post' action='/tpoa/index.php/Home/Info/addOk' enctype='multipart/form-data'>
    ...
    <tbody>
	  ...
	  <tr>
        ...
        <td style="text-align:left;" class="td_bg">
          ...
          <script>
            CKEDITOR.replace('content', {height:250, customConfig: 'custom.js'});
          </script>
        </td>
      </tr>
	  <tr>
